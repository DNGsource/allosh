...
async def join_channel():
    try:
        await sython(JoinChannelRequest("@source_aLLoSH"))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        order = await event.reply('هنا يمك علوش ابشر  @vipaLLosH')
...
async def _(event):
      await event.reply("""السـورس يعمـل |علوش
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
...
async def _(event):
      await event.reply("""علوش : @vipaLLosH"""
)
